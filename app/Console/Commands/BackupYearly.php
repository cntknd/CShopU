...
class BackupYearly extends Command
{
    /**
     ...
     * @var string
     */
    protected $description = 'Create yearly backup of database and files';
    ...
    {
        $this->info('Starting yearly backup...');
        
        $backupService = new BackupService();
        
        // Create complete backup
        $result = $backupService->createCompleteBackup('yearly');
        ...
        if (isset($result['database']['success']) && $result['database']['success'] && 
            ...
            $this->error('Yearly backup failed!');
