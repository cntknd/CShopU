<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="middle_initial" name="middle_initial" type="text" class="mt-1 block w-full" :value="old('middle_initial', $user->middle_initial)" maxlength="1" autocomplete="additional-name" />
